    ...
    7805: function (e, t, i) {
      ...
      function o(e) {
        ...
        function m() {
          ...
          d.forEach((t, s) => {
            ...
            "custom" === l.type && l.renderCustom
              ? ((t.innerHTML = l.renderCustom(i, e + 1, m)),
        ...
        l("changeDirection", () => {
          ...
          l("init", () => {
            !1 === i.params.pagination.enabled ? w() : (g(), f(), m());
          }),
          l("activeIndexChange", () => {
        ...
        for (
          ...
          void 0 !== p[e + t]
            ? (m || (i >= p[e] && i < p[e + t])) &&
              ((f = e), (g = p[e + t] - p[e]))
            : (m || i >= p[e]) &&
              ((f = e), (g = p[p.length - 1] - p[p.length - 2]));
        }
        let v = null,
          w = null;
        l.rewind &&
      ...
      let k = {
            ...
            updateSlidesProgress: function (e) {
              ...
              for (let e = 0; e < i.length; e += 1) {
                ...
                f &&
                  ...
                  c(n, f, t.slideVisibleClass),
                  c(n, m, t.slideFullyVisibleClass),
                  (n.progress = s ? -d : d),
          ...
          breakpoints: {
            setBreakpoint: function () {
              ...
              let m = n.direction && n.direction !== s.direction,
                f = s.loop && (n.slidesPerView !== s.slidesPerView || m),
                g = s.loop;
              m && i && e.changeDirection(), (0, o.w)(e.params, n);
